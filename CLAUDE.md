...
# Project Spec — QS Automation (Job Scraper)
...
| `jobs_filtered` | Subset of `jobs_raw` that Gemini confirmed as temp/freelance. Acts as dedup cache so we don't re-ask Gemini for the same job. |
